        ...
        match (method, class) {
            ...
            (StunMethod::Binding, StunClass::Success | StunClass::Failure) => {
                ...
                if !belongs_to_a_candidate_pair {
                    debug!("Message rejected, transaction ID does not belong to any of our candidate pairs");
                    return false;
                }
            ...
            (
                ...
                debug!("Message rejected, TURN method({method:?}) unexpected in this context");
                false
            }
        }
    }
